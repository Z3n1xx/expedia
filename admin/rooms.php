  ...
  <div style="background:#fff;border:1px solid var(--border);border-radius:var(--r);padding:26px;margin-bottom:24px;box-shadow:var(--shadow-sm)">
    ...
    <form method="POST">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
        ...
        <div class="form-group" style="grid-column:1/-1"><label>Thumbnail URL</label><input type="text" name="thumbnail" value="<?= e($editRoom['thumbnail']??'') ?>" placeholder="https://images.unsplash.com/photo-xxx?w=800&q=80"><div class="form-hint">Paste any image URL — right-click any image online and choose "Copy image address"</div></div>
